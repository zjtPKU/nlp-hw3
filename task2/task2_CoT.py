...
def query_model(question, model=MODEL):
    ...
    prompt = [
        ...
        {"role": "user", "content": f"For each question, provide a detailed solution. Then, show the answer started with \"####\" Make sure that the answer is only a number without any other words!\n Question: \n {question}\n"
        }
    ]
...
nums = 0
predictions=[]
with open("check_CoT.json","w") as f:
